...
@php (date_default_timezone_set('America/Argentina/Buenos_Aires')) 
 ...
 @switch($dia=date("l") and $hora=(date("G")) and $min=date('i'))
                ...
                <video width="100%" height="200" autoplay="" preload="auto" poster="{{$img->get($i)->url}}"  id="player">
                 ...
                 <div class="img-responsive text-center">
                            ...
                            <button class="glyphicon glyphicon-play" style="background:black;color:white; " onclick="document.getElementById('player').play()"></button>                            
                            <button class="glyphicon glyphicon-stop" style="background:black;color:white;" onclick="document.getElementById('player').pause()"></button>
                            <button class="glyphicon glyphicon-volume-up" style="background:black;color:white;" onclick="document.getElementById('player').volume+=0.1"></button>
                            <button class="glyphicon glyphicon-volume-down" style="background:black;color:white;" onclick="document.getElementById('player').volume-=0.1"></button>
                            </div> 
